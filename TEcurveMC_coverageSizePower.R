...
# this code considers the NP-TE estimator

# caveat: a parallelized version of this code is required for nMC=1000 and nBoot=500
...
for (i in 1:length(pi)){
  ...
  save(inferenceVE, file=file.path(currentDir, paste0("TE_coverSizePower_RoyBose_nMC=",nMC,"_N=",n,"_nBoot=",nBoot,"_truncateMarker=",truncateMarker,"_pi=",pi[i],".RData")))
}
